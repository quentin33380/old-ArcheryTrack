<div>
    <nav class="client-nav">
        <p>Navigation</p>
        <ul>
            <x-nav-link route="{{route('dashboard')}}" link="dashboard">Mon profil</x-nav-link>
            ...
            @if(Auth::user()->hasRole('admin'))
                <x-nav-link route="{{route('admin.dashboard')}}" link="">Pannel administrateur</x-nav-link>
            @endif
            <div class="client-info">
                <div class="identity">
                    <div>
                        <img src="https://placehold.co/60x60" alt="">
                        <x-nav-link class="profile_link" link="profile" route="{{route('profile.edit')}}">
                    ...
                    <ul>
                        ...
                        <li class="role">{{Auth::user()->role}}</li>
                    </ul>
                </div>
            </div>
        </ul>
