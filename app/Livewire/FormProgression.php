...
class FormProgression extends Component
{
    ...
    public function mount()
    {
        ...
        if(!empty($profileArcher)){
            $this->arrow_passage_white = $profileArcher->arrow_passage_whit;
    ...
    public function saveProgression()
    {
        ...
        ProfileArcher::updateOrCreate(['user_id' => $user_id], [
            'arrow_passage_white' => $this->arrow_passage_white,
            'arrow_passage_black' => $this->arrow_passage_black,
            'arrow_passage_blue' => $this->arrow_passage_blue,
            'arrow_passage_red' => $this->arrow_passage_red,
            'arrow_passage_yellow' => $this->arrow_passage_yellow,
            'feather_passage_white' => $this->feather_passage_white,
            'feather_passage_black' => $this->feather_passage_black,
            'feather_passage_blue' => $this->feather_passage_blue,
            'feather_passage_red' => $this->feather_passage_red,
            'feather_passage_yellow' => $this->feather_passage_yellow,
        ]);
    }
